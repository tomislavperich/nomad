...
run_once({
	"urxvtd", 
	"unclutter -root",
	"compton --blur-strength 7 --blur-method kawase",
	"sxhkd"
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey }, "m",
        function ()
            ...
            os.execute(string.format("amixer -q set Speaker toggle", beautiful.volume.togglechannel or beautiful.volume.channel))
            beautiful.volume.update()
        end,
